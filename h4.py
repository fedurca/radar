        ...
        (() => {
            ...
            function updateUI(data) {
                ...
                if (displayData) {
                    ...
                    ui.bar.style.width = `${dist_p}%`; ui.bar_dist.style.width = `${dist_p}%`;
                    ui.bar_speed.style.width = `${speed_p}%`; ui.bar_peak.style.width = `${peak_p}%`;
                    ui.bar_cpu.style.width = `${data.cpu_percent}%`; ui.bar_ram.style.width = `${data.ram_percent}%`;
